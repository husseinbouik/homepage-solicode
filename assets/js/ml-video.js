(function() {
            ...
            for (var i = 0; i < vplayer.length; i++) {
                ...
                var source = "https://img.youtube.com/vi/" +"sp6Dnvjm-s8" + "/sddefault.jpg";
                ...
                vplayer[i].addEventListener("click", function() {
                    ...
                    iframe.setAttribute("src", "https://www.youtube.com/embed/" + "sp6Dnvjm-s8"+ "?rel=0&showinfo=0&autoplay=1");
